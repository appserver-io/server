...
/**
 * \AppserverIo\Server\Dictionaries\ServerVars
 *
 * NOTICE OF LICENSE
 *
...
class ServerVars
{
    ...
    const SERVER_AUTO_INDEX = 'SERVER_AUTO_INDEX';
    const SERVER_ERRORS_PAGE_TEMPLATE_PATH = 'SERVER_ERRORS_PAGE_TEMPLATE_PATH';
    const SERVER_WELCOME_PAGE_TEMPLATE_PATH = 'SERVER_WELCOME_PAGE_TEMPLATE_PATH';
    const SERVER_AUTO_INDEX_TEMPLATE_PATH = 'SERVER_AUTO_INDEX_TEMPLATE_PATH';
    const PATH = 'PATH';
    ...
    const VALUE_AUTO_INDEX_ON = 'on';
    const VALUE_AUTO_INDEX_OFF = 'off';
}
