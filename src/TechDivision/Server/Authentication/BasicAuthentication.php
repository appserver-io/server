<?php
/**
 * \TechDivision\Server\Authentication\BasicAuthentication
 *
 * NOTICE OF LICENSE
 *
...
namespace TechDivision\Server\Authentication;

use TechDivision\Server\Interfaces\AuthenticationInterface;
