...
/**
 * TechDivision\Server\Dictionaries\ServerStateKeys
 *
 * NOTICE OF LICENSE
 *
...
use TechDivision\Server\Exceptions\InvalidServerStateException;
...
class ServerStateKeys
{
     ...
     *
     * @return \TechDivision\Server\Dictionaries\ServerStateKeys The server state key instance
     * @throws \TechDivision\Server\Exceptions\InvalidServerStateException
