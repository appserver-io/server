<?php
/**
 * \TechDivision\Server\Sockets\StreamSocket
 *
 * NOTICE OF LICENSE
 *
...
namespace TechDivision\Server\Sockets;
...
class StreamSocket implements SocketInterface
{
     ...
     *
     * @return \TechDivision\Server\Sockets\StreamSocket The Stream instance with a server socket created.
     */
     ...
     * @param resource $context The context to be set on stream create
     *
     * @return \TechDivision\Server\Sockets\StreamSocket The Stream instance with a client socket created.
     */
     ...
     *
     * @return \TechDivision\Server\Sockets\StreamSocket
     */
